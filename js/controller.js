(function(angular) {
    ...
    function MirrorCtrl(
        ...
        _this.init = function() {
            ...
            addCommand('patronus', function() {
              console.log("here is your patronus");
              console.log(SpeechService.commands);
              var patronuses = ['http://cdn0.dailydot.com/uploaded/images/original/2016/9/22/patronuses.gif','http://cdn0.dailydot.com/uploaded/images/original/2016/9/22/Patronus.gif','http://cdn0.dailydot.com/uploaded/images/original/2016/9/22/blackbird.gif','http://cdn0.dailydot.com/uploaded/images/original/2016/9/22/woof-sm.gif']
              $scope.gifimg = patronuses[1];
              $scope.focus = "gif";
              });
